# new-release [![npm version][npmv-img]][npmv-url] [![github release][ghrelease-img]][ghrelease-url] [![License][license-img]][license-url]
...
<p align="center">
  <a href="https://github.com/tunnckoCoreLabs/new-release">
...
- It's exactly the same copy of the [@tunnckocore/release-cli](https://github.com/tunnckoCore/release-cli)
...
Just run `new-release` or `tunnckocore-release` and rest.
...
{%= related(verb.related.list, { words: verb.related.maxWords }) %}
...
[Become a Partner or Sponsor?][patreon-url] :dollar: Check the **Partner**, **Sponsor** or **Omega-level** tiers! :tada: You can get your company logo, link & name on this file. It's also rendered on package page in [npmjs.com][npmv-url] and [yarnpkg.com](https://yarnpkg.com/en/package/new-release) sites too! :rocket:
...
<!-- prettier-ignore -->
| [<img src="https://avatars3.githubusercontent.com/u/5038030?v=4" width="120px;"/><br /><sub><b>Charlike Mike Reagent</b></sub>](https://tunnckocore.com)<br />[💻](https://github.com/tunnckoCoreLabs/new-release/commits?author=tunnckoCore "Code") [📖](https://github.com/tunnckoCoreLabs/new-release/commits?author=tunnckoCore "Documentation") [💬](#question-tunnckoCore "Answering Questions") [👀](#review-tunnckoCore "Reviewed Pull Requests") [🔍](#fundingFinding-tunnckoCore "Funding Finding") |
| :---: |
